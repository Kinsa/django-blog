...
version = __import__('django_blog').__version__
...
setup(
    name='django-blog',
    version=version,
    description="Mulit-Author Blog for Django",
    long_description="""django-blog creates a multi-author blog application
for Django projects. See the project page for more information:
  https://github.com/jbergantine/django-blog""",
    author='Joe Bergantine',
    author_email='jbergantine@gmail.com',
    maintainer='Joe Bergantine',
    maintainer_email='jbergantine@gmail.com',
    url='https://github.com/jbergantine/django-blog',
